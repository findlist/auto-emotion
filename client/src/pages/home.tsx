...
function HomePage({ onEnterIdle, onEnterBattle, onNavigate }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col max-w-2xl mx-auto">
      <header role="banner" className="bg-ink text-cream px-4 sm:px-6 py-3 flex items-center gap-4">
      ...
      <main className="flex-1 p-4 sm:p-6 flex flex-col gap-4 sm:gap-6">
        <section aria-label="压力分布" className="bg-ink text-cream p-4 sm:p-6 rounded-lg">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          <button
            aria-label="进入挂机空间"
            onClick={onEnterIdle}
            className="bg-pink text-cream p-4 sm:p-6 rounded-lg shadow-[4px_4px_0_#1a1a1a] hover:shadow-[2px_2px_0_#1a1a1a] hover:translate-x-[2px] hover:translate-y-[2px] transition-all flex flex-col items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="bg-mint text-ink p-4 sm:p-6 rounded-lg shadow-[4px_4px_0_#1a1a1a] hover:shadow-[2px_2px_0_#1a1a1a] hover:translate-x-[2px] hover:translate-y-[2px] transition-all flex flex-col items-center justify-center gap-2"
          >
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3">
          <div className="bg-yellow text-ink p-2 sm:p-3 rounded-lg text-center">
            <p aria-hidden="true" className="text-xl mb-1">🎁</p>
            <p className="font-mono text-xs">每日奖励</p>
          </div>
          <div className="bg-orange text-cream p-2 sm:p-3 rounded-lg text-center">
            <p aria-hidden="true" className="text-xl mb-1">🏆</p>
            <p className="font-mono text-xs">排行榜</p>
          </div>
          <div className="bg-pink text-cream p-2 sm:p-3 rounded-lg text-center">
            <p aria-hidden="true" className="text-xl mb-1">📦</p>
        ...
        <nav aria-label="更多功能">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-3">
            <button
              ...
              className="bg-cream border-3 border-ink p-2 sm:p-3 rounded-lg shadow-[4px_4px_0_#1a1a1a] hover:shadow-[2px_2px_0_#1a1a1a] hover:translate-x-[2px] hover:translate-y-[2px] transition-all flex flex-col items-center gap-1"
            >
      ...
      <nav aria-label="主导航" role="navigation" className="bg-ink text-cream px-2 sm:px-4 py-2 flex justify-around sticky bottom-0">
        {[
          ...
          <button
            ...
            className={`flex flex-col items-center gap-1 px-3 py-1 rounded transition-colors ${
              activeTab === item.key ? 'bg-pink text-cream' : 'text-cream/60 hover:text-cream'
            }`}
          >
