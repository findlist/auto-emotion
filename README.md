...
- 单次调度总时长上限：4 小时；
- 当前基线进度：品质优化专项 100% 完成（P0 三项收尾任务已于 2026-07-09 验收通过）；后端覆盖率 97% 达标，P2 技术债清理完成；P2 测试补全已完成（15/15 页面全覆盖），P3 体验优化大部分已完成（Token 无感刷新已实现、无障碍适配已完成、PixiJS 资源懒加载经评估为不适用）；上线验收标准 7 项全部达标，项目已达生产就绪状态；所有已完成功能不得重复开发
